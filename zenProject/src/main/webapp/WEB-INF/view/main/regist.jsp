...
td,th{border-bottom: 1px solid #d2d2d2;}
table input[type="text"],table input[type="password"]{width: 370px;}
.container{width: 668px; margin: auto; padding: 0px 100px;}
</style>
</head>
<body>
<div class="container">
		...
		<form:form action="memRegist" method="post" name="frm"
			...
			<table>
				...
				<tbody>
					<tr>
						<th><span>아이디</span></th>
						<td><form:input path="memId" placeholder="ID를 입력하세요." /> <form:errors
								path="memId" /></td>
					</tr>
					<tr>
					...
					<tr>
						<th><span>닉네임</span></th>
						<td><form:input path="memNick" /> <form:errors path="memNick" /></td>
					</tr>
					<tr>
						<th><span>휴대폰 번호</span></th>
						<td><form:input path="memPhone" /> <form:errors
								path="memPhone" /></td>
					</tr>

					<tr>
						<th><span>성별</span></th>
						<td class="as"><form:radiobutton path="memSex" value="M"
								checked="checked" />남자 <form:radiobutton path="memSex"
								value="F" />여자 <form:errors path="memSex" /></td>
					</tr>
					<tr>
						<th><span>이메일</span></th>
						<td><form:input path="memEmail" /> <form:errors
								path="memEmail" /></td>
					</tr>

					<tr>
						<th><span>이메일 수신여부</span></th>
						<td class="as"><input type="radio" name="memEmailChk"
							value="Y" checked />예 <input type="radio" name="memEmailChk"
							value="N" />아니오 <form:errors path="memEmailChk" /></td>
					</tr>
				</tbody>
			</table>
