...
table input{width: 370px;}
td,th{border-bottom: 1px solid #d2d2d2;}
.container{margin: auto;width: 668px; padding: 0px 100px;}
		...
		<form:form action="empJoin" method="post" name="frm"
			...
			<table>
				...
				<tr>
					...
					<td><form:input path="empId" placeholder="ID를 입력하세요." /> <form:errors
							path="empId" /></td>
				</tr>
				<tr>
					<th><span>비밀번호</span></th>
					<td><form:password path="empPw" placeholder="비밀번호를 입력하세요." />
						<form:errors path="empPw" /></td>
				</tr>
				<tr>
					<th><span>비밀번호 확인</span></th>
					<td><form:password path="empPwCon" placeholder="비밀번호를 확인하세요." />
