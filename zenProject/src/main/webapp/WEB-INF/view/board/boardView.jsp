   ...
   <h1 class="h3 mb-3 fw-normal">일반 게시판</h1> 
    <div class="table table-responsive">
        ...
        <tr>
            ...
            <td colspan="3"><c:forTokens items="${dto.boardOrgFile }" delims="," var="fileName" varStatus="idx">
      <a
        ...
        <tr>
            ...
            <td><textarea class="form-control" rows="10" cols="100" name="menuRecipe" id="content" readonly="readonly">${dto.boardCon }</textarea></td>
        </tr>
